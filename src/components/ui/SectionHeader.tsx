...
export default function SectionHeader({
  ...
  return (
    <div className={cn('mb-12 md:mb-16', centered && 'text-center max-w-3xl mx-auto', className)}>
      {subtitle && (
      ...
      {description && (
        <p className="text-slate-400 text-lg md:text-xl font-medium">{description}</p>
      )}
    </div>
  )
}
