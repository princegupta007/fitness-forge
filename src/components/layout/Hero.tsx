    ...
    <div className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <Container className="relative z-20 text-center">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-medium">
            Join the most elite fitness community in Iron City. World-class equipment, expert
            trainers, and a culture of excellence.
          </p>
      ...
      >
        <div className="text-center">
          <div className="text-3xl font-black text-white">{stats?.members || '500+'}</div>
          <div className="text-xs uppercase text-slate-500 font-bold tracking-widest">Members</div>
        </div>
        <div className="text-center">
          <div className="text-3xl font-black text-white">{stats?.trainers || '15+'}</div>
          <div className="text-xs uppercase text-slate-500 font-bold tracking-widest">Trainers</div>
        </div>
        <div className="text-center">
          <div className="text-3xl font-black text-white">{stats?.programs || '30+'}</div>
