...
export const metadata = {
    ...
    description: 'Explore our wide range of fitness programs, from strength training to HIIT and yoga.',
}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <ul className="space-y-6">
                                {[
                                    { title: 'Expert Guidance', desc: 'Certified trainers with years of experience.' },
                                    { title: 'Elite Community', desc: 'Train with motivated, like-minded individuals.' },
                                    { title: 'Modern Equipment', desc: 'Top-of-the-line gear for every training style.' },
                                    { title: 'Trackable Progress', desc: 'Built-in assessment and progress tracking.' },
                                ].map((item, i) => (
